...
// document.querySelector('body').innerHTML = createPlanetHTML(planets[1]);

// used querySelector and innerHTML
// used .map() on planets array to run an arrow function that will return the result of each planet array element after it has passed through createPlanetHTML
// then the results will be stringified through .join('') 
